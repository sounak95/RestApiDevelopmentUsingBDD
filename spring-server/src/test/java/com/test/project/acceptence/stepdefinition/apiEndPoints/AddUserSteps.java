...
public class AddUserSteps extends Objects {
	...
	@Then("^a message saying \"([^\"]*)\" is provided$")
	public void a_message_saying_is_provided(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
		RestAssuredHelper.validateRequestStatus(201);
	}

	@Then("^an error message saying \"([^\"]*)\" is provided$")
	public void an_error_message_saying_is_provided(String arg1) throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
